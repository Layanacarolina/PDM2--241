...
void main() async {
  ...
  // Inserir um aluno
  final aluno = Aluno(nome: ' Layana ', dataNascimento: '2005-05-19');
  final aluno2 = Aluno(nome: ' gerdson costa', dataNascimento: '2006-05-19');
  final aluno3 = Aluno(nome: 'vinicio pitombeira', dataNascimento: '2007-12-29');
